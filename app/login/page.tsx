    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-between bg-white px-6 sm:px-12 xl:px-20 py-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-bold text-gray-900 tracking-tight">ParcelFlow</span>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full">
          <div className="mb-10">
            ...
            <p className="mt-2 text-gray-500 text-base">
              เข้าสู่ระบบเพื่อจัดการและติดตามพัสดุของคุณ
            </p>
          </div>
        ...
        <div className="text-center text-xs text-gray-400">
          © {new Date().getFullYear()} ParcelFlow — ระบบจัดการพัสดุอัจฉริยะ
        </div>
      </div>
      ...
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-700 to-indigo-900">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-32 right-20 w-96 h-96 bg-purple-400/10 rounded-full blur-3xl animated-gradient" style={{animationDelay: '3s'}} />
          <div className="absolute top-1/2 left-1/3 w-48 h-48 bg-indigo-300/10 rounded-full blur-2xl animated-gradient" style={{animationDelay: '5s'}} />
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full px-16">
          ...
          <div className="w-28 h-28 rounded-3xl bg-white/10 backdrop-blur-sm border border-white/10 flex items-center justify-center mb-10 shadow-2xl">
            <svg className="w-14 h-14 text-white/90" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
            </svg>
          </div>
          ...
          <p className="text-indigo-200/70 text-center text-base max-w-sm leading-relaxed">
            ระบบติดตาม วิเคราะห์ และรายงานผลการจัดส่งพัสดุ<br />
            แบบครบวงจรในที่เดียว
          </p>

          {/* Feature Pills */}
          <div className="flex flex-wrap justify-center gap-3 mt-10">
            {["ติดตามพัสดุ Real-time", "วิเคราะห์ No Photo", "รายงานผลรายวัน"].map((feature) => (
              <div key={feature} className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/10 text-sm text-white/80">
