  ...
  return (
    <div className="w-full">
              ...
              paginatedData.map((row, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-center">
                    {row.trend === "worsening" && (
                      <div
                        className="inline-flex items-center justify-center gap-1.5 px-2.5 py-1 rounded-md bg-red-50 text-red-700 dark:bg-red-900/30 dark:text-red-400 border border-red-100 dark:border-red-800"
                    ...
                    {row.trend === "improving" && (
                      <div
                        className="inline-flex items-center justify-center gap-1.5 px-2.5 py-1 rounded-md bg-emerald-50 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-800"
                    ...
                    {row.trend === "stable" && (
                      <div
                        className="inline-flex items-center justify-center gap-1.5 px-2.5 py-1 rounded-md bg-gray-50 text-gray-600 dark:bg-gray-800 dark:text-gray-400 border border-gray-200 dark:border-gray-700"
      ...
      {selectedRow && (
        ...
        >
          <div
            className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-3xl max-h-[85vh] flex flex-col overflow-hidden transform transition-all"
          ...
          >
            <div className="p-5 border-b border-gray-100 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-gray-50/80 dark:bg-gray-800/80">
              ...
              <button
                onClick={() => setSelectedRow(null)}
                className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 self-end sm:self-center"
              >
                <svg
                  className="w-6 h-6"
                  fill="none"
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 text-sm text-gray-600 dark:text-gray-300">
                          <div className="flex items-start gap-1.5">
                            ...
                            <span className="font-medium text-gray-800 dark:text-gray-200 break-words bg-gray-100 dark:bg-gray-700 px-2 rounded-md">
                              {item.office}
                            </span>
                          </div>
                          <div className="flex items-start gap-1.5">
